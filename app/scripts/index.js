var companyContainer = document.getElementById('colors'),
    text = document.getElementById('color-name'),
  ...
  function updateState(event) {
    var name = event.target.innerHTML,
        imageUrl = event.target.getAttribute('data-color-image'),
    ...
    body.style.backgroundImage = 'url(#)'.replace('#', imageUrl);
  };
